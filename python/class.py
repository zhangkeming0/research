...
class Game(object):
    ...
    def __init__(self, start):
        self.quips = [
            "You died. You kinda suck at this.", "Your mom would be proud. If she were smarter.", "Such a laser.", "I have a small puppy that's better at this."
        ]
        self.start = start
    ...
    def central_corridor(self):
        ("The Gothons of Planet Percal #25 have invaded your ship and destroyed,mission is to get the neutron destruct bomb from the Weapons Armory,put it in the bridge, and blow the ship up after getting into an escape pod.\n",
